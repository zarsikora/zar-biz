...
const LesFleursDeMars = () => {
  return /* @__PURE__ */ React.createElement(Wrapper, null, /* @__PURE__ */ React.createElement(Hero, null, /* @__PURE__ */ React.createElement(PinkBlock, null, /* @__PURE__ */ React.createElement("h1", null, "Les Fleurs de Mars")), /* @__PURE__ */ React.createElement(Details, null, /* @__PURE__ */ React.createElement("p", null, "Role: UX designer, UX researcher, graphic designer"), /* @__PURE__ */ React.createElement("p", null, "Status: Complete"), /* @__PURE__ */ React.createElement("p", null, "Duration: August 2021"))), /* @__PURE__ */ React.createElement(SlidesCta, {
    ...
    target: "_BLANK"
  }, "here (desktop)"), " and ", /* @__PURE__ */ React.createElement("a", {
  ...
  }, "infinite objects"), " to riff off a recent surge in NFT popularity but remove the environmentally unfriendly aspect of exclusivity. What if you were able to instantly send a client or loved one a digital model of a flower arrangement which they could interact with on their computer, tablet, or mobile phone? Then, after the intial reception of the gift, receive a physical version of the model cast in a lucite frame some days later? Tight timelines are no longer a problem and a whole new definition of preserved flowers is introduced to the flower arrangement space.")), /* @__PURE__ */ React.createElement("p", null, "In closing, while there are no plans to move into the build phase at this time, I think there is no lack of potential in the ideas presented. Though they can be difficult to ideate around at first, very traditional market areas such as flower arrangement present creatives with some of the most unique opportunities to rejuvenate age-old concepts with modern technologies and ideas."), /* @__PURE__ */ React.createElement("p", null, "Upending traditional ideas regarding access to artisan goods and what qualifies as an appropriate occasion to send and receive them is one of the many ways we can use design and development as a tool to change greater societal conversations. In other words, go send your best friend a rose :)"))));
};
